...
//_remorqueur addAction [("<img image=""client\icons\r3f_tow.paa""/> <t color=""#ff0000"">" + STR_R3F_LOG_action_remorquer_deplace + "</t>"), "scripts\R3F_ARTY_AND_LOG\R3F_LOG\remorqueur\remorquer_deplace.sqf", nil, 6, true, true, "", "R3F_LOG_objet_addAction == _target && R3F_LOG_action_remorquer_deplace_valide"];

//_remorqueur addAction [("<img image=""client\icons\r3f_tow.paa""/> <t color=""#ff0000"">" + STR_R3F_LOG_action_remorquer_selection + "</t>"), "scripts\R3F_ARTY_AND_LOG\R3F_LOG\remorqueur\remorquer_selection.sqf", nil, 6, true, true, "", "R3F_LOG_objet_addAction == _target && R3F_LOG_action_remorquer_selection_valide"];
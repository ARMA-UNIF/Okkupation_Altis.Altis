...
STR_R3F_LOG_action_heliporter = "Objekt heben";
...
STR_R3F_LOG_action_deplacer_objet = "Kiste bewegen";
STR_R3F_LOG_action_relacher_objet = "Kiste fallenlassen";
STR_R3F_LOG_ne_pas_monter_dans_vehicule = "Du kannst nicht in das Fahrzeug einsteigen, mit der Kiste in den Händen!";
STR_R3F_LOG_courir_trop_vite = "Du bewegst dich zu schnell! (Drücke C um langsamer zu gehen!)";
STR_LOCK_OBJECT = "Lock this object";
STR_UNLOCK_OBJECT = "Unlock this object";
STR_RELEASE_HORIZONTAL = "Kiste horizontal fallenlassen";

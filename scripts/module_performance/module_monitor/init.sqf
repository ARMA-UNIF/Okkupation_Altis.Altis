...
_handle_config = [] execVM "scripts\module_performance\module_monitor\config.sqf";
waitUntil{scriptDone _handle_config};

pvpfw_perf_monitorResultsToRPT = compile preProcessFileLineNumbers "scripts\module_performance\module_monitor\dumpPerformanceArrays.sqf";

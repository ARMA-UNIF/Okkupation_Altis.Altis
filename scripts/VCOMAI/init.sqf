...
call compile preProcessFile "scripts\VCOMAI\FSMFunctions\configFunctions.sqf"; 
FiredAtTarget = compile preprocessFile "scripts\VCOMAI\FSMFunctions\HitNear.sqf";
AIHIT = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_AiHit.sqf";
AIPath = compile preprocessFile "scripts\VCOMAI\FSMFunctions\Aiwaypoint.sqf";
VCOM_fnc_ClosestEnemy = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_ClosestEnemy.sqf";
VCOM_fnc_Garrison = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_Garrison.sqf";
VCOM_fnc_LightGarrison = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_LightGarrison.sqf";
Vcom_fnc_VehicleHandle = compile preprocessFile "scripts\VCOMAI\FSMFunctions\Vcom_fnc_VehicleHandle.sqf";
VCOM_fnc_ClosestAllyWarn = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_ClosestAllyWarn.sqf";
VCOM_fnc_KnockDown = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_KnockDown.sqf";
VCOM_fnc_BlowBuilding = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_BlowBuilding.sqf";
VCOM_fnc_HasMine = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_HasMine.sqf";
VCOM_fnc_ReactToFireGrenade = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_ReactToFireGrenade.sqf";
VCOM_fnc_ReactToFireSuppressed = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_ReactToFireSuppressed.sqf";
VCOM_fnc_classVehicle = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_classVehicle.sqf";
VCOM_fnc_MagClass = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_MagClass.sqf";
VCOM_fnc_ChangeFormation = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_ChangeFormation.sqf";
VCOM_fnc_CheckBag = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_CheckBag.sqf";
VCOM_fnc_GuessDirection = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_GuessDirection.sqf";
VCOM_fnc_ReactToFire = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_ReactToFire.sqf";
playMoveEverywhere = compileFinal "	_this select 0 playMoveNow (_this select 1);";
switchMoveEverywhere = compileFinal "_this select 0 switchMove (_this select 1);";
Vcom_fnc_pack = compile preprocessFile "scripts\VCOMAI\FSMFunctions\Vcom_fnc_pack.sqf";
Vcom_fnc_unpack = compile preprocessFile "scripts\VCOMAI\FSMFunctions\Vcom_fnc_unpack.sqf";
VCOM_fnc_HandledHeal = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_fnc_HandledHeal.sqf";
VCOM_EraseMarkers = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_Erasemarker.sqf";
VCOM_DownedAI = compile preprocessFile "scripts\VCOMAI\FSMFunctions\VCOM_DownedAI.sqf";

...
if (isnil "IL_Variables") then
{
	...
	//Supported cargo
	IL_Supported_Tanks_B = ["B_MBT_01_cannon_F", "B_MBT_01_TUSK_F", "B_MBT_01_arty_F", "B_MBT_01_mlrs_F"];
	IL_Supported_Tanks_O = ["O_MBT_02_cannon_F", "O_MBT_02_arty_F"];
	IL_Supported_Tanks_I = ["I_MBT_03_cannon_F"];
	IL_Supported_APC_B = ["B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_CRV_F", "B_APC_Tracked_01_AA_F", "B_APC_Wheeled_01_cannon_F"];
	IL_Supported_APC_O = ["O_APC_Tracked_02_cannon_F", "O_APC_Tracked_02_AA_F", "O_APC_Wheeled_02_rcws_F"];
	IL_Supported_APC_I = ["I_APC_tracked_03_cannon_F", "I_APC_Wheeled_03_cannon_F"];
	IL_Supported_Trucks_Hemtt = ["B_Truck_01_transport_F", "B_Truck_01_covered_F", "B_Truck_01_mover_F", "B_Truck_01_ammo_F", "B_Truck_01_fuel_F", "B_Truck_01_medical_F"];
	IL_Supported_Trucks_Tempest = ["O_Truck_03_device_F", "O_Truck_03_covered_F", "O_Truck_03_transport_F", "O_Truck_03_repair_F", "O_Truck_03_medical_F", "O_Truck_03_ammo_F", "O_Truck_03_fuel_F"];
	IL_Supported_Trucks_Zamak = ["O_Truck_02_covered_F", "O_Truck_02_transport_F", "O_Truck_02_box_F", "O_Truck_02_medical_F", "O_Truck_02_ammo_F", "O_Truck_02_fuel_F", "I_Truck_02_covered_F", "I_Truck_02_transport_F", "I_Truck_02_ammo_F", "I_Truck_02_box_F", "I_Truck_02_medical_F", "I_Truck_02_fuel_F"];
	...
	IL_Supported_VAN = ["C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Van_01_transport_F", "C_Van_01_fuel_F", "B_G_Van_01_fuel_F"];
	...
	IL_Supported_Cargo_MH9 = IL_Supported_Box_H1 + IL_Supported_Box_H2;// + IL_Supported_Backpack_All;
	...
	IL_Supported_Cargo_Veh_C17 = IL_Supported_Cargo_Veh_C130J + IL_Supported_Tanks_B + IL_Supported_Tanks_O + IL_Supported_Tanks_I + IL_Supported_APC_B + IL_Supported_APC_O + IL_Supported_APC_I;
...
if !((_obj_main_type in (IL_Supported_Vehicles_All)) || (_obj_main == Player)) exitwith
{
	if (IL_DevMod) then
	{
		Player globalChat Format["IgiLoad. Objekt: ""%1"" ist nicht unterst?tzt.", _obj_main];
	};
};
...
//	END IL_Init_Veh
	...
	IL_Init_Box =
	{
		...
		if (_obj_type in IL_Supported_Tanks_B) then
		{
		...
		if (_obj_type in IL_Supported_Tanks_O) then
		{
			_obj setVariable["slots", 14, true];
			_obj setVariable["zload_cargo", 1.5, true];
			_obj setVariable["cargo_offset", 4, true];
		...
		if (_obj_type in IL_Supported_Tanks_I) then
		{
			_obj setVariable["slots", 14, true];
			_obj setVariable["zload_cargo", 1.5, true];
			_obj setVariable["cargo_offset", 4, true];
		...
		if (_obj_type in IL_Supported_APC_B) then
		{
			_obj setVariable["slots", 10, true];
			_obj setVariable["zload_cargo", 2.5, true];
			_obj setVariable["cargo_offset", 4, true];
		};

		if (_obj_type in IL_Supported_APC_O) then
		{
			_obj setVariable["slots", 10, true];
			_obj setVariable["zload_cargo", 1.5, true];
			_obj setVariable["cargo_offset", 4, true];
		...
		if (_obj_type in IL_Supported_APC_I) then
		{
			_obj setVariable["slots", 10, true];
			_obj setVariable["zload_cargo", 1.5, true];
			_obj setVariable["cargo_offset", 4, true];
		...
		if (_obj_type in IL_Supported_Trucks_Hemtt) then
		{
			_obj setVariable["slots", 8, true];
			_obj setVariable["zload_cargo", 2.0, true];
			_obj setVariable["cargo_offset", 6.5, true];
		};

		if (_obj_type in IL_Supported_Trucks_Tempest) then
		{
			_obj setVariable["slots", 8, true];
			_obj setVariable["zload_cargo", 1.5, true];
			_obj setVariable["cargo_offset", 4, true];
		...
		if (_obj_type in IL_Supported_Trucks_Zamak) then
		{
			_obj setVariable["slots", 8, true];
			_obj setVariable["zload_cargo", 2.0, true];
			_obj setVariable["cargo_offset", 5, true];
		};
		...
		{
			{
				if (IL_DevMod) then
				{
					Player globalChat Format ["IgiLoad ""%1"". Fracht: ""%2"" gefunden.", IL_Script_Inst, _x];
				};
				...
				{
					[_v, "Diese Fracht ist zu gro?. "] call IL_Vehicle_Chat;
				}
				else
				{
					if (IL_DevMod) then
					...
					{
						[_v, Format ["Laden von ""%1"" in ""%2"" gestartet", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")]] call IL_Vehicle_Chat;
						_done = true;
						_counter = (_box_num);
						...
						{
							[_v, Format ["""%1"" ist auf ""%2"" geladen. Freier Platz: ""%3"".", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName"), abs(_slot_num - _counter)]] call IL_Vehicle_Chat;
						}
						else
						{
							[_v, Format ["""%1"" ist auf ""%2"" geladen. Es ist kein freier Platz mehr!", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName")]] call IL_Vehicle_Chat;
						};
					}
					else
					{
...
//	END IL_Do_Load
	...
	IL_Do_Unload =
	{
		...
		{
			{
				...
				if (_x getVariable "doors" == _doors) then
				{
					...
					if (((_x getVariable "attachedTruck") == _v) && ((_x getVariable "attachedPos") == (_counter)) && (_counter < 0) && !_done) then
					{
						...
						[_v, Format ["""%1"" wurde entladen von ""%2"". Freier Platz: ""%3"".", getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName"), getText(configFile >> "cfgVehicles" >> typeOf _v >> "displayName"), _free_slots]] call IL_Vehicle_Chat;
						sleep 1;
					};
				};
				if (_done) exitWith {};
			...
			if (_skip) then
			{
				[_v, "Kann keine Fracht finden! Erneut versuchen."] call IL_Vehicle_Chat;
				_counter = _counter + 1;
				if (_doors == "B") then
				{
					_v setVariable["box_num", _counter, true];
		...
		{
			[_v, "BOX 404 error. Kiste nicht gefunden!. Zur?cksetzten der Fahrzeugdaten..."] call IL_Vehicle_Chat;
			[_v, true] call IL_Init_Veh;
			[_v, "Fahrzeugdaten zur?ckgesetzt."] call IL_Vehicle_Chat;
		};
		_v setVariable["can_load", true, true];
	};
//	END IL_Do_Unload
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<t color=""#007f0e"">Hinten in CH-49 einsteigen</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload_para.paa' /><t color=""#b200ff""> Abspringen mit Fallschirm</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000""> Entlade Fracht von CH-49</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload_para.paa' /><t color=""#b200ff""> Werfe Fracht mit Fallschirm ab</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload_all_para.paa' /><t color=""#a50b00""> Werfe ALLE Fracht mit Fallschirm ab</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#191970"">Oeffne Frachtrampe am CH-49</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#191970"">Schliesse Frachtrampe am CH-49</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#191970"">Enable loading for Co-Pilot</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#191970"">Disable loading for Co-Pilot</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#191970"">Enable loading from outside</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#191970"">Disable loading from outside</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#191970"">Enable usable ramp</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#191970"">Disable usable ramp</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_CHINOOK) then
{
	...
	if (typeOf _obj_main == "CH_147F") then
	{
		...
		_obj_main addAction [
		"<t color=""#191970"">Open cargo ramp in Chinook</t>",
		{
		...
		_obj_main addAction [
		"<t color=""#191970"">Close cargo ramp in Chinook</t>",
		{
...
if (_obj_main_type in IL_Supported_Vehicles_C17) then
{
	...
	_obj_main addAction [
	"<t color=""#191970"">Open cargo doors in C17</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#191970"">Close cargo doors in C17</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_MH9) then
{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fracht links auf MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fracht rechts auf MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000""> Entlade Fracht links von MH-9</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000""> Entlade Fracht rechts von MH-9</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_OFFROAD) then
{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fracht auf Offroad</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fahrzeug auf Offroad</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000""> Entlade Fracht vom Offroad</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_VAN) then
{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fracht auf VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fahrzeug auf VAN</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000""> Entlade Fracht vom VAN</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_KAMAZ) then
{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fracht auf ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fahrzeug auf ZAMAK</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000""> Entlade Fracht vom ZAMAK</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_TEMPEST) then
{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fracht auf TEMPEST</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fahrzeug auf TEMPEST</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000""> Entlade Fracht vom TEMPEST</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fracht auf HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e""> Lade Fahrzeug auf HEMTT</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000""> Entlade Fracht vom HEMTT</t>",
	{
...
{
	Player globalChat Format["Objekt typ: ""%1"" ist nicht unterst?tzt.", _obj_main_type];
};

...
[] spawn
{
	...
	sleep 15;
	["<t size='0.7'>" + "Mission Design<br/>" + "</t>" + "<t size='0.5'>" + "Team UNIF<br/>" + "www.Arma-Unif.de<br/>" + "</t>",-0.5,0.7,3,-1,0,3011] call bis_fnc_dynamicText;
	sleep 10;
	["<t size='0.7'>" + "Custom Intro by<br/>" + "</t>" + "<t size='0.5'>" + "Continuum" + "</t>",-0.5,0.1,3,-1,0,3011] call bis_fnc_dynamicText;
	sleep 10;
